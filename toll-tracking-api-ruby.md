Toll Tracking API - Node.js
================================
Use Node.js to track Toll shipments with Toll Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "LK201223662AU","courier_code"=>"toll"},{"tracking_number" => "LH290032509AU","courier_code"=>"toll"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"toll"}
      # params  = {"tracking_numbers" => "LK201223662AU,LH290032509AU","courier_code"=>"toll"}
